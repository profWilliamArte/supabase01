...
const $$Papeleria = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Papeleria;
  const categoria = 4;
  const nomCategoria = "Papeleria";
...
}, "C:/laragon/www/arsistema/guias/astro/supabase/supabase01/src/pages/papeleria.astro", void 0);

const $$file = "C:/laragon/www/arsistema/guias/astro/supabase/supabase01/src/pages/papeleria.astro";
const $$url = "/supabase01/papeleria";

export { $$Papeleria as default, $$file as file, prerender, $$url as url };
